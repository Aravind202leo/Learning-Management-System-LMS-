...
const About =()=>{
    ...
    useEffect(()=>{
        Axios.get("http://localhost:3001/api/get/course/web_development").then((res)=>{
        setcontent(res.data[0].content)
         // eslint-disable-next-line no-console
        setTag(...tag,res.data[0].syllabus) 
...
// const tag = ["HTML & CSS– Content, layout, and styling of web page",
